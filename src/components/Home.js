...
function Home({ dealList, pageNumber, handlePageChange }) {
  ...
  listDisplay = list.map((deal) => {
    return (
      <Link
        className="col-6 text-decoration-none mb-3"
        key={deal.steamAppID}
  ...
  return (
    <div>
      ...
      <h1 style={{ color: "#2d00f7" }} className="text-center mt-4">
        Deals
      </h1>
